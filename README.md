...
5. On the first Jarock-managed startup, the configured `server/config/welcomemessage.json5.template-jarock` replaces Welcome Message's generic `welcomemessage.json5` with the Jarock welcome text and links. Later starts preserve the operator's edits.
