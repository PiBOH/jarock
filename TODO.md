...
- [x] Verify the ready banner: the ASCII-art "Done!" banner appears in the console once the server finishes loading (after Geyser when it is installed), and the `Toggle ready banner` option in the parameter manager shows or hides it.
