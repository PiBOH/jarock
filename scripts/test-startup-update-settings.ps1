...
try {
    ...
    Assert ($TuiEntry.Contains('onMouseMove: selectMouseMove')) 'TUI menus attach the mouse hover handler'
    Assert ($TuiEntry.Contains('onMouseDown: selectMouseDown')) 'TUI menus attach the explicit mouse handler'
    Assert ($TuiEntry.Contains('onMouseUp: selectMouseUp')) 'TUI menus attach the mouse-up activation fallback'
    ...
    Assert ($TuiEntry.Contains('activateBoundSelect(this)')) 'TUI click handling executes the selected action'
    ...
    Assert (-not $TuiEntry.Contains('function selectKeyDown')) 'TUI does not replace OpenTUI native Enter handling with a fragile key callback'
    Assert (-not $TuiEntry.Contains('function isSelectConfirmKey')) 'TUI leaves Enter parsing to OpenTUI Select key bindings'
